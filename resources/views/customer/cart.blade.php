        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('img_item_upload/' . ($item['image'] ?? 'default.png')) }}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="" onerror="this.onerror=null;this.src='{{ $item['image'] ?? asset('img_item_upload/default.png') }}';">
                                    </div>
                                </th>
                                <td>
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('cart.clear') }}" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin mengkosongkan semua item di keranjang?')">Kosongkan Keranjang</a>
                </div>
